...
node general_replace "TEST-03" "task_configuration={\"Category:Twinkle使用的模板\":\"Category:Twinkle使用的模板\"}" no_task_configuration_from_section "replace_text_pattern=/维基百科/{{SITENAME}}/g" -use_project=nails
